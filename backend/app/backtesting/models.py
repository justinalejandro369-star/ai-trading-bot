...
class BacktestResult:
    ...
    strategy_name is the name of the BaseStrategy that produced the
    result — persisted so multiple strategies can be compared.
    """
    sharpe_ratio: float
...
class BacktestRequest(BaseModel):
    ...
    strategy_name selects which BaseStrategy to run (default: 'baseline').
    """
    ...
    strategy_name: str = Field(default="baseline", description="Registered strategy name (GET /api/strategies for the list)")
