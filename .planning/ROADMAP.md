...
Plans:
- [x] 03-01-PLAN.md — vectorbt install, BacktestResult/BacktestRequest models, BacktestRun ORM, migration 003, engine.py (run_backtest + shift(1) bias prevention), test_backtest.py
